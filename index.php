...
include 'particles/form.php';
include 'particles/process_form.php';
?>
	...
	<div class="container">
      ...
      <div class="wow fadeInUp col-md-5 col-sm-7" data-wow-delay="0.5s">
       ...
       <div class="wow fadeInUp col-md-4 col-sm-12" data-wow-delay="0.9s">
        	<h2>Fine Dining</h2>
         	<p>Steak House is free website template in HTML CSS for everyone. Please tell your friends about <a rel="nofollow" href="https://www.tooplate.com/free-templates" title="free templates">Tooplate</a> site.</p>
  ...
  <div class="overlay"></div>
    <div class="container">
      <div class="row">
          ...
          <div class="col-md-offset-2 col-md-8 col-sm-12">
              <a class="popup-youtube" href="https://www.youtube.com/watch?v=j-_7Ub-Zkow"><i class="fa fa-play"></i></a>
